...
#save all sprites on map
class Sprites:
    def __init__(self, chek_lvl):
        self.sprite_parameters = {
            ...
            'sprite_flame': {
             ...
             'npc_devil0': {
                'sprite': [pygame.image.load(f'sprites/devil/devil0/base/{i}.png').convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': 0.0,
                'scale': (1.1, 1.1),
                'side': 50,
                'animation': [],
                'death_animation': deque([pygame.image.load(f'sprites/devil/devil0/death/{i}.png')
                ...
                'flag': 'npc',
                'obj_action': deque(
                    [pygame.image.load(f'sprites/devil/devil0/anim/{i}.png').convert_alpha() for i in range(9)]),
                'teg': 'devil0'
            },
            'npc_devil1':{
                'sprite': [pygame.image.load(f'sprites/devil/devil1/base/{i}.png').convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': 0.0,
                'scale': (1.1, 1.1),
                'side': 50,
                'animation': [],
                'death_animation': deque([pygame.image.load(f'sprites/devil/devil1/death/{i}.png')
                ...
                'flag': 'npc',
                'obj_action': deque(
                    [pygame.image.load(f'sprites/devil/devil1/action/{i}.png').convert_alpha() for i in range(6)]),
                'teg': 'devil0'
            },
            'sprite_door_v': {
            ...
            'npc_solider0':{
                'sprite': [pygame.image.load(f'sprites/solidor/solidor0/base/{i}.png').convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': 0.8,
                'scale': (0.4, 0.6),
                'side': 30,
                'animation': [],
                'death_animation': deque([pygame.image.load(f'sprites/solidor/solidor0/death/{i}.png')
                ...
                'flag': 'npc',
                'obj_action': deque(
                    [pygame.image.load(f'sprites/solidor/solidor0/action/{i}.png').convert_alpha() for i in range(4)]),
                'teg': 'solider0'
            },
            'npc_solider1':{
                'sprite': [pygame.image.load(f'sprites/solidor/solidor1/base/{i}.png').convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': 0.8,
                'scale': (0.4, 0.6),
                'side': 30,
                'animation': [],
                'death_animation': deque([pygame.image.load(f'sprites/solidor/solidor1/death/{i}.png')
                                           .convert_alpha() for i in range(11)]),
                'is_dead': None,
                'dead_shift': 1.7,
                'animation_dist': None,
                ...
                'flag': 'npc',
                'obj_action': deque(
                    [pygame.image.load(f'sprites/solidor/solidor1/action/{i}.png').convert_alpha() for i in range(4)]),
                'teg': 'solider1'
            }
        }
        self.chek_lvl = chek_lvl
        if self.chek_lvl == 1:
            self.list_of_objects = [SpriteObject(self.sprite_parameters['sprite_barrel'], (7.1, 2.1)),
                        ...
                        SpriteObject(self.sprite_parameters['npc_devil0'], (7, 4)),
                        SpriteObject(self.sprite_parameters['sprite_flame'], (8.6, 5.6)),
                        SpriteObject(self.sprite_parameters['sprite_door_h'], (1.5, 4.5)),
                        SpriteObject(self.sprite_parameters['npc_solider0'], (2.5, 1.5)),
                        SpriteObject(self.sprite_parameters['npc_solider1'], (5.51, 1.5)),
                        SpriteObject(self.sprite_parameters['npc_solider0'], (6.61, 2.92)),
                        SpriteObject(self.sprite_parameters['npc_solider1'], (7.68, 1.47)),
                        SpriteObject(self.sprite_parameters['npc_solider0'], (8.75, 3.65)),
                        SpriteObject(self.sprite_parameters['npc_solider1'], (1.27, 11.5)),
                        SpriteObject(self.sprite_parameters['npc_solider0'], (1.26, 8.29)),
                        SpriteObject(self.sprite_parameters['npc_devil1'], (4,10))
                ]
        elif self.chek_lvl == 2:
            self.list_of_objects = [SpriteObject(self.sprite_parameters['sprite_barrel'], (7.1, 2.1)),
                        SpriteObject(self.sprite_parameters['sprite_barrel'], (5.9, 2.1)),
                        SpriteObject(self.sprite_parameters['npc_devil0'], (7, 4)),
                        SpriteObject(self.sprite_parameters['npc_solider1'],(5,6))]
        elif self.chek_lvl == 3:
            self.list_of_objects = [SpriteObject(self.sprite_parameters['sprite_barrel'], (7.1, 2.1)),
                                    SpriteObject(self.sprite_parameters['sprite_barrel'], (5.9, 2.1)),
                                    SpriteObject(self.sprite_parameters['npc_devil0'], (7, 4))]
        else:
            self.list_of_objects = [SpriteObject(self.sprite_parameters['sprite_barrel'], (7.1, 2.1)),
                                    SpriteObject(self.sprite_parameters['sprite_barrel'], (5.9, 2.1)),
                                    SpriteObject(self.sprite_parameters['npc_devil0'], (7, 4)),
                                    SpriteObject(self.sprite_parameters['npc_devil0'], (8, 8)),]
